...
export const getUserGists = () =>
  axios.get(`/users/${window._gitstars.user.login}/gists`)
...
export const getRepoReadme = (login, name, source) =>
  axios.get(`/repos/${login}/${name}/readme`, { cancelToken: source.token })
